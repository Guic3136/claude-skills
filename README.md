...
| [claude-hud](./skills/claude-hud) | 🚀 生产力 | 自定义状态栏 - 显示模型、Context、Git 状态 | 1.0.0 | ✅ 稳定 |
| [save-progress](./skills/save-progress) | 🚀 生产力 | 保存会话进度并在压缩后自动加载 | 1.0.0 | ✅ 稳定 |

**总计**: 3 个技能 | [查看所有技能](./registry.yaml)
